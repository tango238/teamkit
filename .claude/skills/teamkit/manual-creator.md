...
```bash
npx --yes @marp-team/marp-cli "{{baseDir}}/{{specDir}}/manual.md" --html --output "{{baseDir}}/{{specDir}}/manual.html"
```
...
```bash
npx --yes @marp-team/marp-cli "{{baseDir}}/{{specDir}}/manual.md" --pdf --output "{{baseDir}}/{{specDir}}/manual.pdf"
```
